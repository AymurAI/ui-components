 ...
 * heading levels, list nodes, tables, and marks come out shaped exactly as
 ...
 * Highlight, the table kit, plus the Markdown extension) intentionally
 * mirrors RichTextEditor's own `useEditor` config so the schema — and
 * therefore the shape of the resulting document — is identical between
 * parsing and live editing.
 */
